...
namespace workspace.Migrations
{
    ...
    [Migration("20241130162514_enseignant5")]
    partial class enseignant5
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("workspace.Models.ApplicationUser", b =>
                {
                    ...
                    b.Property<string>("EnseigenentId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("EnseigenentId")
                        .IsUnique()
                        .HasFilter("[EnseigenentId] IS NOT NULL");
            ...
            modelBuilder.Entity("workspace.Models.ApplicationUser", b =>
                {
                    b.HasOne("workspace.Models.ApplicationUser", "ParentUser")
                        .WithMany()
                        .HasForeignKey("EnseigenentId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("workspace.Models.Enseignant", "Enseignant")
                        .WithOne("User")
                        .HasForeignKey("workspace.Models.ApplicationUser", "EnseigenentId");
